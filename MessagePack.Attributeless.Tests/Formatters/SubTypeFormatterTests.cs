...
public class SubTypeFormatterTests
{
    ...
    public void Deserialize_throws_if_it_encounters_an_unknown_key()
    {
        ...
        action.Should()
            ...
            .WithMessage("Failed to deserialize MessagePack.Attributeless.Tests.Samples+IExtremity value.")
            .WithInnerException<MessagePackSerializationException>()
            .WithMessage(
                "Encountered unknown type key 1 for IExtremity - was this serialized with a different configuration?");
